...
docker exec cli.org1 bash -c 'peer channel update -o orderer.hlf11.com.au:7050 -c testchannel -f ./channels/org1_anchor.tx'
docker exec cli.org2 bash -c 'peer channel update -o orderer.hlf11.com.au:7050 -c testchannel -f ./channels/org2_anchor.tx'
