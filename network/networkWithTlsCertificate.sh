...
docker exec cli.org1 bash -c 'peer channel create -c testchannel -f ./channels/testchannel.tx -o orderer.hlf11.com.au:7050  --tls true --cafile /var/hyperledger/orderer/tlscacerts/tlsca.hlf11.com.au-cert.pem'


read -p "press any key to let peers join the testchannel"
#let peer join three channels
docker exec cli.org1 bash -c 'peer channel join -b testchannel.block --tls true --cafile /var/hyperledger/orderer/tlscacerts/tlsca.hlf11.com.au-cert.pem'
docker exec cli.org2 bash -c 'peer channel join -b testchannel.block --tls true --cafile /var/hyperledger/orderer/tlscacerts/tlsca.hlf11.com.au-cert.pem'
...
docker exec cli.org1 bash -c 'peer channel update -o orderer.hlf11.com.au:7050 -c testchannel -f ./channels/org1_anchor.tx --tls true --cafile /var/hyperledger/orderer/tlscacerts/tlsca.hlf11.com.au-cert.pem'
docker exec cli.org2 bash -c 'peer channel update -o orderer.hlf11.com.au:7050 -c testchannel -f ./channels/org2_anchor.tx --tls true --cafile /var/hyperledger/orderer/tlscacerts/tlsca.hlf11.com.au-cert.pem'
