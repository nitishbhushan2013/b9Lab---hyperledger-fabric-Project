...
configtxgen -profile testChannel -outputAnchorPeersUpdate ./channels/Org1MSPanchors.tx -channelID testchannel -asOrg org1MSP
configtxgen -profile testChannel -outputAnchorPeersUpdate ./channels/Org2MSPanchors.tx -channelID testchannel -asOrg org2MSP
