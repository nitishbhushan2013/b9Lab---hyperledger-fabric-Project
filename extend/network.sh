...
docker exec cli.org1 bash -c 'peer channel create -c testchannel -f ./channels/testchannel.tx -o orderer.hlf11.com.au:7050'
...
docker exec cli.org1 bash -c 'peer channel update -o orderer.hlf11.com.au:7050 -c testchannel -f ./channels/Org1MSPanchors.tx'
docker exec cli.org2 bash -c 'peer channel update -o orderer.hlf11.com.au:7050 -c testchannel -f ./channels/Org2MSPanchors.tx'
